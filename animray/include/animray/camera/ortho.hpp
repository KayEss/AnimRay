...
namespace animray {
    ...
    template<typename R, typename C = flat_camera<typename R::local_coord_type>>
    class ortho_camera {
        /// The 2d camera
        C camera;
      ...
      public:
        ...
        using extents_type = typename camera_type::extents_type;
        /// The type used to measure the physical resolution of the camera
        using resolution_type = typename camera_type::resolution_type;
        ...
        ray_type operator()(resolution_type x, resolution_type y) const {
            ...
            using end_type = typename ray_type::end_type;
            return ray_type(
                    end_type(pc.x, pc.y, focal_plane),
